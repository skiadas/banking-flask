...
r = client.post("/transaction", json={ "type": "Deposit", "amount": 30 , "user": "pete" })
assert(r.status_code == 201)
r = client.post("/transaction", json={ "type": "Withdrawal", "amount": 10 , "user": "pete" })
assert(r.status_code == 400)
r = client.post("/transaction", json={ "type": "Withdrawal", "amount": 10 , "user": "pete", "password": "peteishere" })
assert(r.status_code == 201)
assert("Location" in r.headers)
r = client.get("/user/pete?password=peteishere")
